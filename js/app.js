(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".partners__slider-first")) new core(".partners__slider-first", {
            modules: [ Autoplay ],
            slidesPerView: "auto",
            spaceBetween: 50,
            autoHeight: true,
        ...
        if (document.querySelector(".partners__slider-second")) new core(".partners__slider-second", {
            modules: [ Autoplay ],
            slidesPerView: "auto",
            spaceBetween: 50,
            autoHeight: true,
